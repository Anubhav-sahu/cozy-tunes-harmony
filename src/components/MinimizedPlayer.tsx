...
const MinimizedPlayer: React.FC<MinimizedPlayerProps> = ({
  ...
  return (
    <div
      className="fixed bottom-6 left-1/2 transform -translate-x-1/2 glass-panel py-2 px-4 
                rounded-full shadow-lg flex items-center gap-3 cursor-pointer z-50 animate-fade-in"
